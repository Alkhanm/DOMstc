<template>
  ...
  >
    ...
    <text fill="currentColor" x="50%" y="40%" text-anchor="middle" dominant-baseline="middle" >{{text}}</text>
    <text fill="currentColor" x="50%" y="52%" text-anchor="middle" dominant-baseline="middle" >{{value}}</text>
  </svg>
</template>

<script lang="js">
/* Retirado de: https://www.npmjs.com/package/vue-circle-counter */
export default {
  beforeCreate() {
